...
This agent uses Google ADK to facilitate Web Search via Brave.
It integrates with the Brave Search MCP server.
"""
...
from tools import (
    brave_web_search, brave_local_search, brave_news_search, 
    brave_video_search, brave_image_search
)
from mcp_client import BraveMCPClient, _mcp_ctx
...
async def send_message_async(prompt: str, user_email: str = None, project_id: str = None, session_id: str = "default") -> str:
    ...
    if RedisEventPublisher:
         try:
             publisher = RedisEventPublisher("Brave Search Agent", "Search Specialist")
