...
# Context variables for tracking user/session state
_session_id_ctx: ContextVar[str] = ContextVar("session_id", default="default")
_user_email_ctx: ContextVar[str] = ContextVar("user_email", default="unknown")
_auth_token_ctx: ContextVar[str] = ContextVar("auth_token", default=None)  # [NEW] OAuth Token Context
